  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
        {[
          { label: 'Negócios em aberto', value: d.dealsCount, sub: R$(d.dealsValue), color: 'text-erplus-accent' },
          { label: 'Empreendimentos', value: d.projectsCount, sub: d.projectsByStage || '—', color: 'text-blue-500' },
          { label: 'Orçamentos ganhos', value: `${d.wonQuotes}/${d.totalQuotes}`, sub: `Taxa: ${d.conversionRate}%`, color: 'text-green-500' },
          { label: 'Tarefas pendentes', value: d.pendingTasks, sub: `${d.overdueTasks} atrasadas`, color: d.overdueTasks > 0 ? 'text-red-500' : 'text-amber-500' },
          { label: 'Agenda hoje', value: d.todayEvents, sub: 'eventos', color: 'text-blue-500' },
        ].map((kpi, i) => (
